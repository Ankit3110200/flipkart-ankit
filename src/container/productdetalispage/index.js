        ...
        <div className="flexRow">
          <div className="verticalImageStack">
            {
              ...
              <div className="thumbnail">
                <img src={generatepublicimgUrl(thumb.img)} alt={thumb.img} />
              </div>
              )
            }
          ...
          <div className="productDescContainer">
            <div className="productDescImgContainer">
              <img src={generatepublicimgUrl(product.productDetails.productpicture[0].img)} alt={`${product.productDetails.productpicture[0].img}`} />
            </div>
